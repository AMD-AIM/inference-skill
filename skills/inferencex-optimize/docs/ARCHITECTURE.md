...
This document defines the canonical architecture for the InferenceX optimization harness. It is the single source of truth for the four-plane model, evidence lifecycle, rollback procedure, and rework protocol.
